...
- **Zooms**
  - Default `min_zoom=6`, `max_zoom=12`. Visible when zoomed out; detailed enough without massive size.
- **Tile Size**
  - Uses 512x512 pixel tiles for better performance and smaller file sizes.
- **Compression**
